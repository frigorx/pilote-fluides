(() => {
  ...
  const routeSceneAnimee = routeScene + `
    <div class="flux-controls">
      ...
      <p class="flux-etat" aria-live="polite">Repère EAU au départ. Lance le trajet : le texte décrit chaque passage.</p>
    </div>`;
  ...
  function brancherFlux(scene) {
    ...
    rejouer.addEventListener("click", () => {
      ...
      etat.textContent = "Repère EAU au départ. Lance le trajet : le texte décrit chaque passage.";
    });
    positionner(0);
  }
