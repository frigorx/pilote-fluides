(() => {
  ...
  const parallelSceneAnimee = parallelScene + `
    <div class="flux-controls">
      ...
      <p class="flux-etat" aria-live="polite">Repère EAU au départ. Lance le trajet : il suit la branche 2, les autres branches font pareil en parallèle.</p>
    </div>`;
  ...
  function brancherFlux(scene) {
    ...
    rejouer.addEventListener("click", () => {
      ...
      etat.textContent = "Repère EAU au départ. Lance le trajet : il suit la branche 2, les autres branches font pareil en parallèle.";
    });
    positionner(0);
  }
