(() => {
  ...
  function curveScene({ k = .5, speed = 1, id = "circ-curve" } = {}) {
    ...
    const desc = `Graphique débit-hauteur. La courbe pompe descend et la courbe réseau monte. Leur intersection est à environ ${fr(qOp,1)} mètre cube par heure et ${fr(hOp,1)} mètre de colonne d’eau dans ce modèle simplifié.`;
