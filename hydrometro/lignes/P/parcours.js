...
(() => {
  ...
  const activities = [
    ...
    { type: "Calcul avec unité", prompt: "Calculez P ≈ 1,16 × Q × ΔT pour Q = 1,5 m³/h et ΔT = 10 K.", numeric: { value: 17.4, tolerance: .05, units: ["kW", "W", "m³/h"], unit: "kW" }, explanation: "1,16 × 1,5 × 10 = 17,4 kW.", families: ["units", "power"], stations: ["puissance"] },
    ...
    { type: "Décision argumentée", prompt: "Vous mesurez un ΔT élevé. Quelle vérification est la plus solide avant un diagnostic ?", options: ["Contrôler débit, charge, points et organes", "Remplacer immédiatement la pompe", "Augmenter la température sans relever"], correct: 0, explanation: "Un ΔT isolé n’identifie pas une cause unique. Il faut croiser des preuves.", families: ["dt", "measure"], stations: ["delta-t", "debit", "mesurer"] },
    ...
    { type: "Calcul avec unité", prompt: "Le départ vaut 62 °C et le retour 52 °C. Calculez ΔT.", numeric: { value: 10, tolerance: .01, units: ["K", "kW", "m³/h"], unit: "K" }, explanation: "ΔT = 62 − 52 = 10 K. L’écart numérique vaut aussi 10 °C.", families: ["units", "dt"], stations: ["delta-t"] },
