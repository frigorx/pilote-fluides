...
window.PILOTE_PACK = {
 ...
 "banque": [
  ...
  },
  {
   ...
   "niveau": 2,
   "type": "qcm",
   "enonce": "Le R-22 (HCFC), même recyclé ou régénéré, est interdit pour la maintenance dans l'UE depuis :",
   "choix": [
    "2000",
    "2010",
    "2015",
  ...
  },
  {
   ...
   "remediation_vers": "g9b",
   "niveau": 1,
   "enonce": "Sur quelle pression le KVR agit-il ?",
   "choix": [
    "La pression d'évaporation, en sortie d'évaporateur",
    "La pression d'aspiration, à l'entrée du compresseur",
    "La pression de condensation, en sortie de condenseur",
   ...
   "bonne": 2,
   "aide": "Le KVR se monte à la sortie du condenseur. Quelle pression y règne-t-il ?",
   "remed": {
    "regle": "Le KVR agit sur la pression de condensation, en sortie de condenseur. Il la maintient suffisamment haute.",
    ...
    "piege": "Croire qu'il protège l'installation d'une pression trop HAUTE — c'est le rôle du pressostat HP, une sécurité. Le KVR fait l'inverse : il empêche la HP de tomber trop bas."
   },
   "explication": "Le KVR agit sur la pression de condensation, en sortie de condenseur. Il la maintient suffisamment haute.",
   "origine": "pack",
   "chapitre": "09",
   "chapitre_titre": "Composant : détendeurs et autres organes",
   "chapitre_fichier": "CONTENU-09-G9-detendeurs.md",
 ...
 "cartes": [
  ...
  },
  {
   ...
   "notes_pilote": "À passer AVANT tout le reste, et à reprendre avant la première manipulation. Charte FrigorX : la sécurité se démontre et s impose, elle ne se découvre jamais par l erreur. Faire ouvrir une VRAIE fiche de données de sécurité pendant la séance : c’est le document que le stagiaire devra savoir consulter seul, sur chantier."
  },
  {
   "id": "s1",
   "type": "cours",
  ...
  },
  {
   ...
   "notes_pilote": "Ce module se projette en préliminaire, juste après le module sécurité et AVANT que le stagiaire ne choisisse sa catégorie : il doit voir les familles de fluides avant de savoir quel parcours il suit. Ordre voulu — on protège d'abord la personne (module sécurité), puis on nomme ce qui la menace (ce module-ci). ⚠ Contrairement au risque électrique, ce contenu EST au référentiel et EST évaluable : 1.08 (combustibilité, propagation de flamme, charge et occupation) et 11.03 sont du tronc commun théorique. Ne pas dire en salle qu'il ne sera pas noté. Faire ouvrir une VRAIE fiche de données de sécurité et y faire chercher la classe et les valeurs : c'est le geste professionnel visé, pas la mémorisation."
  },
  {
   "id": "cl1",
   "type": "cours",
  ...
  },
  {
   ...
   "minuteur_s": 600,
   "corps": "<p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/capsules/index.html?c=cl3\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🎧 Écouter la capsule : CO₂ : deux dangers mortels — la pression et l'air qu'il vous prend ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">Le chapitre expliqué à voix haute, écran par écran, avec ses animations — 7 écrans, 8 minutes. Version imprimable et mode projection compris.</span></p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/co2-r744/index.html?e=securite\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🧊 Aller plus loin : sécurité et intervention sur une installation R744 ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">L'escale « Sécurité » de la ligne CO₂ — les trois risques, le matériel de mesure dédié, le groupe de maintien à l'arrêt, et la catégorie d'attestation qui s'applique. 9 minutes.</span></p><img src=\"packs/fluides/res/svg/co2-point-bas.svg\" alt=\"Animation : le CO₂ remplit le local par le bas ; un technicien descend l'escalier et entre dans la nappe. Respirable à hauteur de visage, mortel en bas de l'escalier.\" style=\"width:100%;height:auto;display:block;margin:0 0 18px;border:1px solid #d7e0e8;border-radius:8px\"><p><b>Ce qui arrive.</b> Le CO₂, le R-744, est classé <b>A1</b> : toxicité faible, non inflammable, PRP de 1. Sur le papier, c'est la case la plus rassurante de toute la matrice. <b>Sa classe n'annonce pourtant aucun des deux risques qui tuent réellement sur ces installations</b> : la <b>pression</b>, et l'<b>anoxie</b>. Méfiez-vous du raccourci « CO₂ = A1 = tranquille » : il est faux.</p><p>Ce fluide entre aujourd'hui dans le parc : froid commercial, supermarchés, chambres froides. Vous en rencontrerez dès vos premiers chantiers.</p><p><b>Premier danger : la pression.</b> Une installation au CO₂ travaille à des pressions <b>bien plus élevées</b> que celles des fluides que vous connaissez, sans commune mesure. Cela change tout le matériel : manifold, flexibles, vannes, tout doit être <b>dédié au CO₂</b>. Brancher un manifold ordinaire sur une installation au CO₂, c'est le faire éclater dans les mains. Pour fixer l'ordre de grandeur : côté haute pression, une centrale transcritique travaille couramment <b>jusqu'à 120 bar environ</b>. La valeur exacte dépend du point de fonctionnement et se lit sur la <b>plaque de l'installation</b> et dans la documentation du constructeur, jamais dans un cours. Et ce chiffre ne change rien à la règle : <b>aucun réflexe acquis sur un R-134a ou un R-410A ne se transpose ici</b>.</p><p>Cette pression garde son danger <b>machine à l'arrêt</b>. Une installation au CO₂ arrêtée continue de monter en pression si elle se réchauffe : c'est pour cela qu'elle possède des dispositifs de sécurité qui lui sont propres. Une installation au CO₂ laissée sans surveillance après une coupure n'est pas une installation au repos.</p><p>À la détente à l'air libre, le CO₂ peut passer directement à l'état solide : c'est la <b>glace carbonique</b> (ou neige carbonique). Double conséquence : une <b>brûlure par le froid</b> au contact de la peau, et un <b>bouchon solide</b> qui obstrue une vanne ou une tuyauterie. Et ce bouchon finit par fondre : le gaz qu'il libère alimente alors le second danger.</p><p><b>Second danger : l'air qu'il vous prend.</b> Le mot <b>anoxie</b> désigne le manque d'oxygène dans l'organisme. Vous avez rencontré ce danger dans la fiche « L'air qui manque » : un gaz prend la place de l'air respirable. Le CO₂ fait cela, <b>et il fait plus</b>.</p><p><b>L'azote et le CO₂ n'agissent pas de la même façon.</b> L'azote agit uniquement par <b>déplacement</b> : il est inerte, il prend la place de l'oxygène sans réagir avec l'organisme. Le CO₂, lui, agit <b>en plus par lui-même</b> : il n'est pas inerte, il intervient dans la régulation de la respiration et devient nocif à des concentrations où l'oxygène restant serait encore suffisant. Le CO₂ peut donc vous mettre en danger <b>avant</b> d'avoir chassé assez d'oxygène pour qu'un contrôle du seul taux d'oxygène s'en alarme. C'est pourquoi, sur une installation au CO₂, <b>un détecteur d'oxygène seul ne suffit pas</b> : il faut une mesure du CO₂ lui-même.</p><p>N'en concluez pas que les fluides fluorés sont inoffensifs : à forte concentration, ils agissent eux aussi sur l'organisme : effet sur le rythme du cœur, effet endormant. Leur fiche de données de sécurité le mentionne — là encore, « A » ne veut pas dire inoffensif.</p><p><b>Ce que vous ressentirez, et pourquoi c'est déjà tard.</b> Contrairement à l'azote, qui ne prévient pas du tout, le CO₂ <b>donne des signes</b> : souffle court puis <b>essoufflement violent</b>, <b>maux de tête</b>, <b>vertiges</b>, bourdonnements, sueurs. La raison est celle vue en fiche « L'air qui manque » : c'est l'excès de gaz carbonique dans le sang qui commande l'envie de respirer. Ces signes sont votre <b>seule chance</b>, mais ils arrivent alors que vous êtes <b>déjà dans la nappe</b>, et à forte concentration la perte de connaissance suit en quelques instants. <b>Essoufflement brutal ou mal de tête soudain dans un local technique : vous ressortez immédiatement</b>. On ne cherche pas à comprendre sur place, on ne finit pas le geste en cours.</p><p><b>Pourquoi on entre sans le savoir.</b> Le CO₂ est <b>incolore</b>, <b>inodore</b>, et <b>plus lourd que l'air</b>. Il ne monte pas : il s'écoule et <b>s'accumule dans les points bas</b> : fosse, cave, sous-sol, local en contrebas, bas d'une chambre froide. Une zone peut être parfaitement respirable à hauteur de visage et déjà mortelle au niveau du sol, ou en bas de quelques marches. La répartition réelle dépend de la fuite et du local : un jet sous pression brasse le gaz, une ventilation le dilue. La nappe au point bas reste le cas défavorable, celui qu'on suppose tant qu'une <b>mesure</b> n'a pas dit le contraire.</p><p><b>Attention à ne pas généraliser cette règle.</b> « Plus lourd que l'air » vaut pour le CO₂ et pour la plupart des fluides fluorés, mais <b>pas pour l'ammoniac</b> (R-717), plus léger que l'air : lui, il monte. Le comportement d'un fluide se lit sur sa FDS, il ne se suppose jamais par analogie avec le fluide précédent.</p><p><b>Comment ça arrive vraiment.</b> Une installation au CO₂ en local technique enterré, une fuite lente pendant la nuit, porte fermée. Le gaz remplit le volume par le bas. Au matin, un technicien descend relever un paramètre. À mi-escalier, il a mal à la tête et le souffle court. Il met cela sur le compte de la fatigue et continue : il n'en a que pour deux minutes. Il ne remonte pas. Puis un collègue le voit au sol et descend le chercher, sans protection : la nappe est toujours là. La plupart de ces accidents font leur seconde victime à cet instant précis.</p>",
   "blocs": [
    {
     "type": "cle",
     "t": "Ce qu'il faut retenir",
     "html": "<ul><li>Le CO₂ est <b>A1</b>, et pourtant il tue de <b>deux</b> façons : la <b>pression</b> et l'<b>anoxie</b>. Sa classe n'annonce ni l'une ni l'autre.</li><li>Pressions <b>sans commune mesure</b> avec les fluides courants (<b>jusqu'à 120 bar environ</b> en haute pression transcritique) : matériel <b>dédié au CO₂</b>, jamais un manifold ordinaire.</li><li>Une installation au CO₂ <b>à l'arrêt reste sous pression</b>, et remonte en pression si elle se réchauffe.</li><li>Glace carbonique à la détente : <b>brûlure par le froid</b> et <b>bouchon</b>.</li><li>Le CO₂ <b>déplace</b> l'oxygène <b>et agit par lui-même</b>, là où l'azote est inerte. Un <b>détecteur d'oxygène seul ne suffit pas</b>.</li><li><b>Essoufflement brutal, mal de tête, vertiges : on ressort tout de suite.</b> Ces signes arrivent quand on est déjà dans la nappe.</li><li>Incolore, inodore, <b>plus lourd que l'air</b> : il gagne les <b>points bas</b> — la nappe s'y suppose tant qu'une mesure n'a pas dit le contraire. Pas vrai pour l'ammoniac.</li></ul>"
    },
    {
     "type": "piege",
     "t": "Le geste interdit",
  ...
  },
  {
   ...
   "question": {
    ...
    "bonne": 1,
    "explication": "Le fluide indiqué sur l'étiquette de la bouteille doit être exactement celui de l'installation. Mélanger deux fluides différents rend le contenu de la bouteille inutilisable pour le recyclage ou la régénération.",
    "remediation_vers": "p2"
   },
   "criteres": [
    {
   ...
   "blocs": [
    {
     ...
     "html": "Une bouteille d'azote <b>ne se branche jamais en direct</b> sur un circuit, mano-détendeur absent. La mise en pression se fait <b>à l'azote sec, seul</b>. Jamais d'oxygène, explosif au contact de l'huile. Jamais d'air comprimé, humide et chargé en oxygène."
    },
    {
     "type": "cle",
  ...
  },
  {
   ...
   "minuteur_s": 420,
   "corps": "<img src=\"packs/fluides/res/svg/ordre-vannes.svg\" alt=\"Animation : les étapes de la déconnexion s'allument une à une sur le montage — fermer la vanne, laisser la pression se stabiliser, desserrer lentement, purger le flexible.\" style=\"width:100%;height:auto;display:block;margin:0 0 18px;border:1px solid #d7e0e8;border-radius:8px\"><p>Un manifold, ce sont des <b>vannes</b>. Les ouvrir et les fermer dans le bon ordre n'est pas un détail. Un mauvais ordre peut lâcher un nuage de fluide au visage, ou libérer un flexible sous pression.</p><p>À la <b>connexion</b>, l'ordre est simple : vannes fermées, on raccorde les flexibles, on chasse l'air resté à l'intérieur par une ouverture brève, puis on ouvre progressivement.</p><p>C'est à la <b>déconnexion</b> que l'ordre compte le plus. Il ne change jamais :</p><ol><li><b>Fermer</b> la vanne, côté circuit puis côté appareil.</li><li><b>Laisser la pression se stabiliser.</b> Observer le manomètre. Tant que l'aiguille bouge encore, on attend.</li><li><b>Desserrer lentement</b> le raccord du flexible, à peine, par petites touches. On écoute. On continue. Jamais d'un coup.</li><li>S'il reste du fluide <b>emprisonné dans le flexible</b>, le récupérer par l'appareil déjà branché. Jamais le laisser partir à l'air libre.</li><li>Déconnecter seulement quand la pression est retombée et confirmée.</li></ol><p>La même logique s'applique pour <b>vider ou remplir une bouteille</b>, en phase liquide comme en phase gazeuse. Une bouteille de réfrigérant a une prise dédiée à chaque phase, ou s'utilise dans un sens précis pour tirer du liquide. On suit toujours le marquage de la bouteille, jamais un raccord forcé.</p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/chaine-intervention-interactive/index.html?dossier=deconnecter\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🧭 Lancer le cours interactif : la chaîne de l’intervention ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">Fermer, stabiliser, récupérer le résidu et desserrer lentement — la chorégraphie complète.</span></p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/vanne-service-interactive/index.html?ecran=positions\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🔩 Lancer le cours interactif : la vanne de service, ce que chaque position ferme ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">Fermée sur l’arrière, intermédiaire, fermée sur l’avant : la coupe animée montre quel passage s’ouvre et quel volume reste isolé — un volume isolé n’est ni vide ni sans pression.</span></p>",
   "blocs": [
    {
     "type": "cle",
     "t": "La chorégraphie qui ne change jamais",
     "html": "<b>Fermer → laisser stabiliser → desserrer lentement.</b> Ces trois gestes reviennent à chaque déconnexion, quel que soit l'appareil branché. C'est le geste central de tout ce module : une fois automatique, il protège dans toutes les situations."
    },
    {
     "type": "piege",
     "t": "Le geste interdit",
     "html": "Desserrer un raccord <b>encore sous pression</b>, d'un coup. Purger le résidu d'un flexible <b>à l'air libre</b> pour aller plus vite. Chaque émission compte, même petite : l'objectif est toujours le <b>minimum d'émission</b>, pas le minimum d'effort."
    }
   ],
   "question": {
    "type": "qcm",
    ...
    "bonne": 1,
    "explication": "On attend que la pression se stabilise. On desserre lentement. Le fluide encore présent dans le flexible se récupère : il n'est pas relâché. Une pression faible reste une pression : geste brusque et purge à l'air libre sont tous deux à écarter.",
    "remediation_vers": "p5"
   },
   "criteres": [
    {
  ...
  },
  {
   ...
   "blocs": [
    ...
    },
    {
     ...
     "html": "Sur le palier, la température ne bouge pas, et beaucoup en concluent qu'il ne se passe rien. C'est l'inverse : <b>c'est le moment où le fluide échange le plus de chaleur</b>. Prendre le palier pour un temps mort, c'est passer à côté du rôle même de l'évaporateur."
    },
    {
     "type": "piege",
  ...
  },
  {
   ...
   "blocs": [
    ...
    },
    {
     ...
     "html": "R-32 et R-290 se ressemblent sur l'étiquette ; pourtant l'un est A2L, l'autre A3. La famille chimique dit l'<b>impact environnemental</b> ; la classe NF EN 378 dit le <b>risque de manipulation</b>. Il faut les deux lectures, à chaque fois."
    },
    {
     "type": "piege",
   ...
   "question": {
    ...
    "bonne": 1,
    "explication": "La série R-4xx désigne les mélanges zéotropes : plusieurs fluides assemblés, avec un glissement de température dont l'ampleur varie d'un mélange à l'autre : quasi nul sur certains, plusieurs kelvins sur d'autres. La lettre majuscule finale (A, B, C) distingue les proportions du mélange.",
    "remediation_vers": "g1c"
   },
   "criteres": [
    {
  ...
  },
  {
   ...
   "question": {
    ...
    "bonne": 1,
    "explication": "Zéro chlore : l'ozone est tranquille. Mais leur stabilité leur donne un fort pouvoir de réchauffement, d'où Kyoto, Kigali et le phase-down F-Gas. Le problème a changé de terrain : après l'ozone, le climat.",
    "remediation_vers": "g2a"
   },
   "criteres": [
    {
   ...
   "blocs": [
    {
     ...
     "html": "<b>tonnes éq. CO₂ = charge (kg) × PRP ÷ 1000</b><br>C'est cette valeur, et non le poids de fluide, qui déclenche une partie des obligations. Deux installations de même charge n'ont pas les mêmes contraintes si les fluides diffèrent."
    },
    {
     "type": "piege",
  ...
  },
  {
   ...
   "question": {
    ...
    "bonne": 1,
    "explication": "Le fluide liquide se dilate quand la température monte. Une bouteille trop remplie n'a plus de volume d'expansion : le taux de remplissage maximal n'est pas une précaution, c'est une règle de sécurité.",
    "remediation_vers": "g5a"
   },
   "criteres": [
    {
  ...
  },
  {
   ...
   "notes_pilote": "Le geste à faire répéter : peser AVANT. Beaucoup de stagiaires pèsent après et déduisent — c'est faux dès qu'il reste du fluide dans la bouteille. Sur un groupe A2, insister sur la précision : sur une charge de 800 g, 50 g d'écart changent le comportement de la machine. Faire remplir un registre à chaque manipulation d'atelier, même en exercice.",
   "categories": [
    "A1",
    "A2",
    "D"
  ...
  },
  {
   ...
   "minuteur_s": 420,
   "corps": "<p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/regulateurs-kv-pedagogiques/index.html\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🧊 Lancer le cours interactif : la famille des régulateurs KV — KVP, KVL, KVR ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">8 écrans : à quoi sert chaque vanne (KVP tient l'évaporation, KVL protège le compresseur, KVR tient la HP), la reconnaître sur le terrain, la placer au bon endroit du circuit, comprendre le clapet qui traduit la pression en mouvement, régler au manomètre et jamais à l'aveugle, distinguer un symptôme d'un diagnostic — vue 3D du produit et questions d'entraînement, environ 15 minutes.</span></p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/pupitre-reglage-interactif/index.html\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🎚️ S'entraîner au pupitre : consigne, différentiel, preuve ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">Deux pupitres manipulables (thermostat de chambre froide, pressostat basse pression) : réglez la consigne et le différentiel, lisez les points d'action en direct, serrez trop le différentiel et voyez l'alerte de courts-cycles — puis un contrôle corrigé. Valeurs d'exercice : la notice fait foi.</span></p><img src=\"packs/fluides/res/svg/detendeurs-ligne.svg\" alt=\"La ligne liquide et ses accessoires, dans l’ordre : réserve de liquide, filtre déshydrateur, voyant, électrovanne, détendeur.\" style=\"width:100%;height:auto;display:block;margin:0 0 18px;border:1px solid #d7e0e8;border-radius:8px\"><p>Autour du détendeur, d'autres organes se <b>règlent</b> et se <b>contrôlent</b>. Ils ne dosent pas le fluide. Ils protègent l'installation et lui évitent de gaspiller de l'énergie. Cette fiche en présente quatre : les thermostats, la soupape de régulation de pression, les limiteurs de pression, et le séparateur d'huile.</p><p>Le <b>thermostat</b> commande un organe (compresseur, vanne) selon une <b>température</b>. Le thermostat <b>mécanique</b> utilise un bulbe relié par un tube fin à des contacts électriques : simple et robuste. Le thermostat <b>électronique</b> utilise une sonde reliée à un régulateur numérique : plus précis, et plus simple à régler. Dans les deux cas, le point de consigne se règle <b>selon la fiche constructeur</b>, jamais à l'estime.</p><p>La <b>soupape de régulation de pression</b> ne coupe rien : elle <b>module en continu</b> pour maintenir une pression stable à un point du circuit. Le <b>limiteur de pression</b> est différent : c'est une sécurité. Mécanique, il est réglé par un ressort. Électronique, il utilise un capteur relié à un module. Dans les deux cas, il <b>coupe le circuit</b>, le plus souvent le compresseur, dès qu'un seuil de pression est franchi, en haute comme en basse pression. La régulation module, la sécurité coupe ; leurs réglages ne se confondent pas. Le pressostat BP peut aussi servir de régulation : sur une petite chambre froide en pump down, c’est lui qui arrête et relance le compresseur selon la pression d’aspiration.</p><p><b>Les régulateurs de pression, chacun à sa place.</b> Sur le terrain, ces vannes portent des repères de catalogue (la série <b>KV</b> est la plus répandue) et chacune tient une pression <b>à un endroit précis du circuit</b>. Un repère mal lu, et l'on règle la mauvaise vanne.</p><p><b>KVP — régulateur de pression d'évaporation.</b> Il se monte <b>à la sortie de l'évaporateur</b>, sur l'aspiration. Il empêche la pression d'évaporation de descendre sous une valeur choisie, donc la température de descendre trop bas. C'est lui qui tient une chambre à 0 °C sans geler la marchandise, et lui qui permet à plusieurs évaporateurs réglés à des températures différentes de travailler sur un même compresseur.</p><p><b>KVL — régulateur de pression de carter.</b> Il se monte sur l'aspiration, <b>juste avant le compresseur</b>. Il limite la pression qui arrive au compresseur au démarrage ou après un dégivrage, quand l'évaporateur est encore chaud. Sans lui, le moteur force et peut disjoncter : il protège le compresseur, il ne règle pas la chambre.</p><p><b>KVR — régulateur de pression de condensation.</b> Il se monte <b>à la sortie du condenseur</b>, souvent avec une vanne de mise en pression de la bouteille. Quand il fait froid dehors, la haute pression tombe et le détendeur n'a plus assez d'écart pour alimenter l'évaporateur. Le KVR retient le liquide dans le condenseur pour <b>maintenir la haute pression</b> et rendre au détendeur sa pression de travail. C'est le remède classique d'une installation qui fonctionne l'été et se dérègle l'hiver.</p><p><b>KVC — régulateur de capacité, ou vanne de by-pass des gaz chauds.</b> Il relie le refoulement à l'aspiration. Quand la demande de froid tombe très bas, il renvoie une part des gaz chauds vers l'aspiration pour que le compresseur garde du débit au lieu de s'arrêter et de repartir sans cesse. Il <b>évite les courts-cycles</b> ; en revanche il consomme, et il ne se monte que là où le constructeur le prévoit. Sur une pompe à chaleur réversible, la vanne quatre voies inverse le sens du cycle : l’échangeur intérieur devient condenseur en hiver, évaporateur en été. Elle se commande, elle ne se règle pas.</p><p><b>La règle de réglage est la même pour toutes.</b> On raccorde le manomètre sur la prise de la vanne, on tourne la vis <b>par petites touches</b>, et on <b>attend la stabilisation</b> avant de lire : une installation frigorifique ne répond jamais instantanément. Le sens de rotation et la plage se lisent sur la notice : aucune de ces vannes ne se règle à l'oreille, et une vanne réglée sans manomètre n'est pas réglée.</p><p><b>La bouteille anti-coup de liquide</b> se place sur l'aspiration, avant le compresseur. Elle recueille le liquide qui n'a pas fini de s'évaporer et ne laisse repartir que de la vapeur, en réadmettant l'huile petit à petit par un orifice calibré. On la trouve là où la charge varie brutalement, et sur les installations à dégivrage par gaz chauds.</p><p><b>Le pressostat différentiel d'huile</b> ne surveille pas une pression, mais un <b>écart</b> : celui entre la pression d'huile de la pompe du compresseur et la pression du carter. Si cet écart ne s'établit pas dans le délai prévu par le constructeur, le compresseur n'est pas lubrifié et l'appareil coupe. Sur les compresseurs qui en sont équipés, il se réarme <b>à la main</b>, et jamais sans avoir cherché pourquoi il a coupé.</p><p>Le <b>séparateur d'huile</b> se place juste après le compresseur (à droite), avant le condenseur (en haut). C'est là que passe en premier la vapeur chaude chargée d'huile. Il retient cette huile puis la renvoie au carter du compresseur, automatiquement, dès que le niveau monte. <b>Vérifier son fonctionnement</b>, c'est contrôler que ce retour se fait bien : une huile qui s'accumule plus loin dans le circuit réduit l'échange de chaleur, et finit par manquer au compresseur.</p><p>Après ces réglages et ce contrôle, on <b>rédige un rapport</b> sur l'état de chaque organe. Un thermostat qui dérive, un limiteur qui ne coupe plus, un séparateur qui laisse passer l'huile : non signalés, ces défauts finissent par endommager le système. À terme, faute de mesure, cela provoque une fuite ou une émission de réfrigérant. Le rapport écrit permet d'agir <b>avant</b> ce stade.</p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/tome-3-technologie-organes/index.html?dossier=regulateurs-securite\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">📘 Lancer le cours interactif : Tome 3 — la technologie de l'organe ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">Les organes annexes un par un : réservoir, filtre déshydrateur, voyant, électrovanne, clapet et vannes de service, bouteille anti-coup de liquide, séparateur d'huile, régulateurs de pression et soupape — chacun en vue isolée, avec son symbole normalisé.</span></p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/vanne-service-interactive/index.html?ecran=geste\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🔩 Lancer le cours interactif : la vanne de service et la prise du pressostat ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">Pourquoi le pressostat se raccorde sur P1 et non sur la voie de service : cette prise reste reliée au compresseur dans toutes les positions de la vanne — donc sous pression, bouchon jamais défait sur une installation chargée.</span></p><p class=\"lien-experience\" style=\"margin:16px 0\"><a href=\"packs/fluides/res/bouteille-liquide-pedagogique/index.html\" target=\"_blank\" rel=\"noopener\" style=\"display:inline-block;padding:10px 22px;background:#1b3a63;color:#fff;font-weight:700;text-decoration:none;border-radius:999px\">🫙 Lancer le cours interactif : la bouteille liquide ▸</a><br><span style=\"font-size:13px;color:#5a6b7d;display:inline-block;margin-top:6px\">14 écrans : reconnaître le réservoir, sa place après le condenseur, le tube plongeur, entrée et départ liquide, la vanne de départ qui n'est pas un détendeur, rassembler la charge côté condenseur, verticale ou horizontale, et la protection DESP.</span></p>",
   "blocs": [
    {
     "type": "cle",
  ...
  },
  {
   ...
   "criteres": [
    ...
    {
     "code": "1.06",
     "libelle": "Connaître le comportement du CO₂ et de l'ammoniac dans le cycle, et ce qui les sépare des fluides fluorés.",
     "officiel": "Connaître le comportement spécifique, les paramètres physiques, les systèmes, les solutions, les déviances de tous les réfrigérants de substitution dans le cycle de réfrigération et les composants pour leur utilisation",
     "groupe": "G1",
     "groupe_titre": "Législation et thermodynamique élémentaire",
     "epreuve": {
    ...
    {
     "code": "1.07",
     "libelle": "Reconnaître les caractéristiques du CO₂ et de l'ammoniac face aux fluides fluorés : pression, toxicité, matériaux.",
     "officiel": "Connaître les caractéristiques des hydrocarbures, du CO2, et du NH3 et des autres réfrigérants non fluorés par rapport aux réfrigérants à gaz à effet de serre fluorés",
     "groupe": "G1",
     "groupe_titre": "Législation et thermodynamique élémentaire",
     "epreuve": {
