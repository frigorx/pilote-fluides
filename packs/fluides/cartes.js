...
export const CARTES = [
  ...
  },
  {
    ...
    corps:
      ...
      "<p>Vous devez braser un raccord sur un tronçon de circuit. Il reste un peu de fluide à l'intérieur, non récupéré — « une petite quantité, ça ne changera rien », pensez-vous. Vous chauffez au chalumeau. La flamme touche le fluide résiduel dans le tube. Il se décompose, et les fumées toxiques se dégagent juste sous votre visage, penché sur le brasage.</p>",
    blocs: [
