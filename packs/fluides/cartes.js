...
export const CARTES = [
  ...
  },
  {
    ...
    corps:
      ...
      "l'<b>atmosphère irrespirable</b> en local fermé (il est plus lourd que l'air, s'accumule en " +
      "point bas, et agit sur la respiration ; voir « CO₂ : deux dangers mortels »), et le risque de " +
