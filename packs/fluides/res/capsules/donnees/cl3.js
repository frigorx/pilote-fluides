...
CAPSULE.declarer({
  ...
  ecrans: [
...

    {
      ...
      texte: "<p>Une installation au CO₂ travaille à des pressions <b>bien plus élevées</b> que celles que vous connaissez. Brancher un manifold ordinaire, c'est le faire <b>éclater dans les mains</b>.</p><p>Cette pression garde son danger <b>machine à l'arrêt</b> : elle continue de monter si elle se réchauffe. Et à la détente à l'air libre, le CO₂ peut se solidifier en <b>glace carbonique</b> : brûlure par le froid, et bouchon qui obstrue une vanne.</p>",
      dire: "Premier danger : la pression. Une installation au CO2 travaille à des pressions bien plus élevées que celles des fluides que vous connaissez, sans commune mesure. Manifold, flexibles, vannes : tout doit être dédié au CO2. Brancher un manifold ordinaire sur une installation au CO2, c'est le faire éclater dans les mains. Les valeurs exactes se lisent dans la documentation constructeur ; ce qu'il faut retenir sans aucun chiffre, c'est qu'aucun réflexe acquis sur un R-134a ou un R-410A ne se transpose ici. Cette pression garde son danger machine à l'arrêt : une installation au CO2 arrêtée continue de monter en pression si elle se réchauffe. Et à la détente à l'air libre, le CO2 peut passer directement à l'état solide : c'est la glace carbonique. Double conséquence, une brûlure par le froid au contact de la peau, et un bouchon solide qui obstrue une vanne ou une tuyauterie.",
