...
CAPSULE.declarer({
  ...
  intro: "Une récupération en cours, une bouteille qui approche de sa limite, et deux bouteilles qui attendent sur l'étagère : laquelle choisir, et pourquoi ? Cette capsule ne refait pas le cours sur la récupération, elle te fait chercher.",
  codes: [
  ...
  ecrans: [
    {
      ...
      texte: "<p>Tu récupères le fluide d'une chambre froide, avant de remplacer un composant. Bon réflexe : tu as pesé la bouteille <b>avant</b> de commencer.</p><p>La récupération avance normalement. Sur un chantier, qu'est-ce qui pourrait t'obliger à t'arrêter avant d'avoir vidé tout le circuit ?</p>",
      dire: "Tu es en train de récupérer le fluide d'une chambre froide, avant de remplacer un composant. Bon réflexe dès le départ : tu as pesé la bouteille avant de commencer, tu sais donc exactement ce qu'elle pesait à vide. La récupération avance normalement. Mais sur un chantier, qu'est-ce qui pourrait t'obliger à t'arrêter avant d'avoir fini de vider le circuit ? Prenez trente secondes avant de passer à l'écran suivant.",
      reference: "Fiche x3 · G5 · parcours D",
    },

    {
      id: "la-balance-approche",
      titre: "Ce que tu constates",
      ...
      dire: "Regarde ce que tu as autour de toi. La balance approche du niveau maximal admissible de la bouteille. Il reste pourtant visiblement du fluide dans le circuit : ce n'est pas fini. Sur l'étagère du fourgon, tu as deux bouteilles disponibles. Une bouteille de récupération vide. Et une bouteille déjà entamée, qui contient un autre fluide.",
...

    {
      ...
      texte: "<p>Tu bascules le flexible sur la bouteille vide, et tu la <b>pèses avant</b> de continuer, exactement comme la première.</p><p>Tu termines la récupération dans cette seconde bouteille, jusqu'à ce que le circuit soit vide.</p>",
      dire: "La bonne réponse : tu changes de bouteille. Tu bascules le flexible sur la bouteille vide, et tu la pèses avant de continuer, exactement comme tu as pesé la première. Tu termines la récupération dans cette seconde bouteille, jusqu'à ce que le circuit soit vide.",
...

    {
      ...
      legende: "Une bouteille pleine se ferme, s'étiquette, et se consigne au registre — avant de repartir avec toi.",
      ...
      dire: "Le réflexe à garder pour la suite de ta carrière : on pèse avant chaque bouteille, pas seulement la première de la journée. Une bouteille pleine se ferme, s'étiquette, et se consigne au registre. Et méfie-toi de la phrase qui semble pleine de bon sens : « quelques centaines de grammes, ça ne change rien ». C'est exactement le geste qui met la bouteille en danger, dépasser le niveau maximal la rend dangereuse dès qu'elle prend un peu de chaleur.",
