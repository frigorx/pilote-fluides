/* GÉNÉRÉ par build/films.mjs depuis ozone.jsx — ne pas modifier ici.
...
(function () {
  ...
  function Unit({
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        width: 156,
        height: 114,
        transform: 'rotate(-14deg) translateX(' + shake + 'px)',
      ...
      style: {
        ...
        boxShadow: '0 10px 24px rgba(27,58,99,0.22)',
        display: 'flex',
  ...
  function DataCard({
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "ODP \u2014 destruction de l'ozone"), /*#__PURE__*/React.createElement("div", {
      style: {
        font: FL,
        color: '#5b6b7d',
        marginTop: 8
      }
    }, "Pouvoir destructeur de 1 kg de fluide, compar\xE9 au R11"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: 22,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          height: '100%',
          width: Math.max(nul ? 0 : 8, r.v * 100 * g) + '%',
          background: nul ? '#2f8f5b' : 'linear-gradient(90deg,#8f6ae8,' + C.uv + ')',
          borderRadius: 10
        }
      })), /*#__PURE__*/React.createElement("div", {
        style: {
      ...
      style: {
        ...
        padding: '20px 24px',
        borderRadius: 16,
        background: 'rgba(47,158,196,0.12)',
        border: '2px solid rgba(47,158,196,0.4)',
        font: "bold 32px 'Trebuchet MS', sans-serif",
        color: C.blue,
        opacity: MOTION.enter(appear + 2.6, 0, 1, 0.6)(T)
      }
    }, "ODP nul ne veut pas dire sans effet : le PRP, lui, reste \xE9lev\xE9."));
  }
  const SEGS = 46,
    A0 = -172,
    A1 = -8;
  function Piece(props) {
    ...
    const t = props.t;
    const K = CUES;
    const camS = interpolate([0, K.Fuite, K.Destruction + 1.4, K.ODP, K.Montreal, K.Montreal + 3.4, K.Bilan + 4], [1.0, 1.14, 1.08, 1.0, 1.10, 1.02, 1.0], Easing.easeInOutCubic);
    const camX = interpolate([0, K.Fuite, K.Destruction + 1.4, K.ODP, K.Montreal, K.Bilan + 4], [540, 380, 520, 540, 520, 540], Easing.easeInOutCubic);
    const camY = interpolate([0, K.Fuite, K.Destruction + 1.4, K.ODP, K.Montreal, K.Bilan + 4], [700, 780, 640, 700, 660, 700], Easing.easeInOutCubic);
    const s = camS(T),
      fx = camX(T),
      fy = camY(T);
    ...
    const cfcs = [0, 0.34, 0.68].map((off, i) => {
      ...
      return {
        ...pt,
        o: alive ? Math.sin(Math.PI * clamp(p, 0, 1)) : 0,
        k: i,
        l: i === 1 ? 'R12' : 'CFC'
      };
    });
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        inset: 0,
        opacity: burn * 0.5,
        background: 'linear-gradient(180deg,rgba(122,90,224,0.5),rgba(122,90,224,0))'
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: 0,
        transformOrigin: '0 0',
        transform: 'translate(' + -fx * (s - 1) + 'px,' + -fy * (s - 1) + 'px) scale(' + s + ')'
      }
    }, uvs.map(u => /*#__PURE__*/React.createElement(Arrow, {
      key: 'uv' + u.k,
      x: u.pt.x,
      y: u.pt.y,
      angle: u.dir,
      ...
      return /*#__PURE__*/React.createElement("div", {
        style: {
          ...
          height: 380,
          borderRadius: '50%',
          opacity: clamp(half / 14, 0, 1) * 0.85,
      ...
      shake: shake,
      leakOn: leakOn
    }), cfcs.map(m => /*#__PURE__*/React.createElement("div", {
      key: 'cfc' + m.k,
      style: {
        position: 'absolute',
        left: m.x - 44,
        ...
        justifyContent: 'center',
        opacity: m.o,
        boxShadow: '0 6px 16px rgba(27,58,99,0.14)'
      }
    }, m.l)), cls.map(m => /*#__PURE__*/React.createElement("div", {
      key: 'cl' + m.k,
      style: {
        position: 'absolute',
        left: m.x - 44,
        ...
        justifyContent: 'center',
        opacity: m.o,
        boxShadow: '0 0 22px rgba(122,90,224,0.5)'
      }
    ...
    }, "1 atome de chlore d\xE9truit", /*#__PURE__*/React.createElement("br", null), "jusqu'\xE0 100 000 mol\xE9cules d'O\u2083")), /*#__PURE__*/React.createElement(DataCard, {
      T: T,
      appear: K.ODP + 0.2,
      leave: K.Montreal - 0.5
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        left: 0,
        ...
        top: 132,
        textAlign: 'center',
        opacity: clamp(stamp, 0, 1),
        transform: 'scale(' + (0.86 + 0.14 * clamp(stamp, 0, 1)) + ') rotate(-3deg)'
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'inline-block',
    ...
    }, "PROTOCOLE DE MONTR\xC9AL \xB7 1987"), /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 16,
        maxWidth: 780,
        marginLeft: 'auto',
        marginRight: 'auto',
        font: '600 26px Calibri, sans-serif',
        color: '#5b6b7d',
        lineHeight: 1.3
      }
    }, "Retour au niveau de 1980 attendu vers 2066 au-dessus de l'Antarctique (OMM/PNUE, 2022)")), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: 0,
    ...
    }, "La couche se soigne", /*#__PURE__*/React.createElement("br", null), "parce qu'on a chang\xE9 de fluide."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'inline-block',
        marginTop: 26,
        padding: '16px 30px',
    ...
    }, "ODP r\xE9gl\xE9 \xB7 le PRP, c'est maintenant")), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        left: 46,
        top: 40,
    ...
    }, "Couche d'ozone & ODP"), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        right: 46,
        bottom: 26,
      ...
      items: [{
        at: K.Bouclier + 0.6,
        until: K.Bouclier + 3.4,
        text: "La couche d'ozone filtre les rayons ultraviolets."
      }, {
        at: K.Bouclier + 3.4,
        until: K.Fuite - 0.2,
        text: 'Sans elle, les UV arriveraient directement au sol.'
      }, {
        at: K.Fuite + 0.2,
        until: K.Fuite + 3.4,
        text: 'Un équipement qui fuit libère du CFC : R11, R12.'
      }, {
        at: K.Fuite + 3.4,
        until: K.Destruction - 0.2,
        text: "Ces molécules montent jusqu'à la stratosphère."
      }, {
        at: K.Destruction + 0.2,
        until: K.Destruction + 3.4,
        text: "Le chlore qu'elles libèrent casse les molécules d'ozone."
      }, {
        at: K.Destruction + 3.4,
        until: K.Destruction + 6.4,
        text: 'Un seul atome de chlore en détruit des dizaines de milliers.'
      }, {
        at: K.Destruction + 6.4,
        until: K.ODP - 0.2,
        text: "Le bouclier s'ouvre : les UV atteignent le sol."
      }, {
        at: K.ODP + 0.2,
        until: K.ODP + 3.4,
        text: "L'ODP mesure ce pouvoir de destruction."
      }, {
        at: K.ODP + 3.4,
        until: K.Montreal - 0.2,
        text: 'R11 : ODP = 1. R22 : 0,055. Les HFC : 0.'
      }, {
        at: K.Montreal + 0.2,
        until: K.Montreal + 3.4,
        text: 'Protocole de Montréal, 1987 : les CFC sont interdits.'
      }, {
        at: K.Montreal + 3.4,
        until: K.Montreal + 6.4,
        text: 'Tous les pays ont signé, et tous ont appliqué.'
      }, {
        at: K.Montreal + 6.4,
        until: K.Bilan - 0.2,
        text: "La couche d'ozone se reconstitue peu à peu."
      }, {
        at: K.Bilan + 0.2,
        until: K.Bilan + 5.2,
        text: "Les HFC ne détruisent plus l'ozone… mais ils réchauffent le climat."
      }]
    }) : null);
  }
  function OzonePiece() {
