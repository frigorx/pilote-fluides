...
const phases = [
  { id: "prepare", label: "1 · Préparer", title: "Analyser et préparer le poste", objective: "Localisez le composant, choisissez le mode d'intervention, puis vérifiez le poste et les positions de départ." },
  { id: "connect", label: "2 · Poser le manifold", title: "Contrôler puis raccorder le manifold", objective: "Contrôlez le manifold et les flexibles, puis raccordez chaque extrémité équipée de sa mini-vanne au bon appareil." },
  { id: "pre-vacuum", label: "3 · Purger l'air", title: "Mettre les lignes au vide", objective: "Évacuez l'air des flexibles et du chemin de la station avant d'ouvrir le cylindre." },
  { id: "liquid", label: "4 · Liquide", title: "Récupérer la phase liquide", objective: "Créez le chemin HP vers la station ; la bouteille reçoit le fluide par son raccord VAPEUR." },
  { id: "vapor", label: "5 · Vapeur", title: "Finir en phase vapeur", objective: "Isolez la HP, basculez l'entrée station, puis récupérez par la BP." },
  { id: "purge", label: "6 · Auto-purge", title: "Vider la Minimax-E", objective: "Isolez le circuit, arrêtez la machine, placez le sélecteur noir sur PURGE et videz la station." },
  { id: "weigh", label: "7 · Peser", title: "Peser et libérer la station", objective: "Notez la masse finale, calculez la masse récupérée et déposez la branche station." },
  { id: "final-vacuum", label: "8 · Vide final", title: "Tirer l'installation au vide", objective: "Après intervention et épreuve d'étanchéité, ouvrez les deux côtés vers la pompe, atteignez la cible du plateau puis contrôlez la tenue." },
];
...
function speakCurrent() {
  ...
  const action = currentAction();
  const phase = currentPhase();
  const utterance = new SpeechSynthesisUtterance(`${mode === "guided" ? action.title : phase.title}. ${mode === "guided" ? action.instruction : phase.objective}`);
