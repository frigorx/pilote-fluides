...
(function () {
  ...
  var css =
    ...
    "#lisib-bouton.dans-entete{position:static;flex:none;width:38px;height:38px;box-shadow:none}" +
    ...
    "#lisib-panneau.dans-entete{top:62px;bottom:auto}" +
    ...
    "@media(max-width:650px){#lisib-bouton.dans-entete{width:32px;height:32px;font-size:13px}#lisib-panneau.dans-entete{top:50px;right:6px}}" +
  ...
  function construire() {
    ...
    var entete = document.querySelector(".header-actions");
    if (entete) {
      b.className = "dans-entete";
      p.className = "dans-entete";
      entete.insertBefore(b, entete.querySelector(".exit-link"));
    } else {
