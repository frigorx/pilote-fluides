...
(window.AEROREZO_STATIONS = window.AEROREZO_STATIONS || []).push({
  ...
  narration: {
    ...
    comprendre: "En janvier, passez la main devant la grille de rejet d’une extraction simple : l’air en sort tiède. Ce tiède-là, quelqu’un l’a payé. Tout le principe est là : au lieu de partir au ciel, cet air longe l’air neuf, séparé de lui par une simple tôle. Le métal laisse filer la chaleur, jamais l’air, sinon les odeurs des sanitaires reviendraient par les bouches de soufflage. Reste à juger l’appareil : trois relevés suffisent, pris là où ils veulent dire quelque chose. Le calcul affiché pose une seule question : combien de degrés l’air neuf a-t-il gagné, sur tous ceux qu’il pouvait gagner ? Le plafond, c’est l’air extrait lui-même — on ne réchauffe rien au-delà de sa source. D’où l’erreur de chantier la plus fréquente : la sonde clipsée juste après la batterie de chauffage. Elle mesure la batterie, l’échangeur récolte le mérite. Le chiffre est flatteur, la réception est signée, et c’est la facture de l’hiver suivant qui rétablit la vérité. Au-delà de cent pour cent, même conclusion : ce n’est pas l’appareil qui est exceptionnel, c’est le relevé qui ment.",
