...
(window.AEROREZO_STATIONS = window.AEROREZO_STATIONS || []).push({
  ...
  cap: "Identifie les sources internes et solaires.",
  bac: "Classe les apports par famille sans double comptage.",
  bts: "Utilise les scénarios d’occupation, protections et données climatiques du projet.",
  ...
  method: "Écris les hypothèses : horaire, occupation, éclairage, équipements, orientation et protection solaire.",
  ...
  consigne: "Réponds à la question posée sous la scène, puis reprends-la sur un cas concret : un bureau plein sud, vitré, vingt personnes, occupé de 8 h à 18 h. Écris à part les six hypothèses à poser avant le moindre calcul — heure retenue, effectif présent, activité, puissance d’éclairage, taux d’usage des équipements, protection solaire. Demande-toi enfin, pour chaque ligne, d’où sortirait la valeur : d’un document du projet, d’un relevé sur place, ou d’une supposition.",
  lecture: "Une réponse juste ne suffit pas ici : ce qui compte est la trace écrite. Un bilan d’apports internes et solaires ne se relit pas sans ses hypothèses — un autre technicien doit pouvoir retrouver le même résultat à partir de ce que tu as noté. Si une ligne de ta liste n’a pas de source, c’est une supposition : elle se signale et elle se fait valider, elle ne se cache pas dans un total.",
