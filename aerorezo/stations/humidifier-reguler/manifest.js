...
(window.AEROREZO_STATIONS = window.AEROREZO_STATIONS || []).push({
  ...
  cap: "Distingue température et humidité.",
  bac: "Observe l’action d’une consigne et d’un capteur.",
  bts: "Conçoit une séquence de régulation cohérente, avec sécurités et modes économes.",

  /* Découvrir — ce que l'élève observe, pas ce qu'il doit conclure. */
  decouverte: "Le même air, à deux températures : le nombre de gouttes de vapeur ne change pas, c’est la place disponible pour elles qui grandit. Une centrale fait exactement cela chaque matin d’hiver — elle prend l’air du dehors, et elle le chauffe. Rien n’a été ajouté, rien retiré. Regarde le point de rosée calculé sous les curseurs : c’est la seule valeur affichée qui dise ce que l’air porte réellement en eau. Retiens-la, tu vas t’en servir.",
  ...
  consigne: "Règle l’air neuf d’hiver — 5 °C et 80 % d’humidité relative — et note le point de rosée affiché. Monte ensuite la température à 20 °C, comme le fait la batterie chaude, puis cherche l’humidité relative qui redonne ce même point de rosée, à un dixième de degré près : c’est l’air que tu obtiens sans avoir ajouté une seule goutte d’eau. Passe enfin à l’été, 26 °C et 60 %, et lis le point de rosée obtenu.",
  lecture: "Tu dois trouver environ 30 % après la batterie chaude, contre 80 % à l’entrée : exactement la même eau, et un air devenu sec. C’est ce qui justifie un humidificateur, et c’est ce qu’on compare à la plage d’humidité visée par le projet. En été, le point de rosée lu devient une consigne : une batterie froide qui ne descend pas sous cette température refroidira l’air sans lui retirer un gramme d’eau.",
