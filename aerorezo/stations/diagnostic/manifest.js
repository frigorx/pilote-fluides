...
(window.AEROREZO_STATIONS = window.AEROREZO_STATIONS || []).push({
  ...
  cap: "Croise débit faible, bruit et état du filtre.",
  bac: "Classe les hypothèses puis choisis le prochain contrôle.",
  bts: "Sépare symptômes, mesures, hypothèses, test discriminant et décision.",

  /* Découvrir — ce que l'élève observe, pas ce qu'il doit conclure. */
  decouverte: "En haut du schéma, un symptôme : le débit est trop faible à une bouche. En dessous, trois causes possibles, et sous chacune le contrôle qui lui correspond. Rien n’indique laquelle est la bonne, et c’est exactement la situation d’un dépannage. Regarde les trois branches avant de lire la suite : elles expliquent toutes le même symptôme, aussi bien l’une que l’autre.",
