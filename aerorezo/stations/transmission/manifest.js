...
(window.AEROREZO_STATIONS = window.AEROREZO_STATIONS || []).push({
  ...
  cap: "Repère mur, vitrage, toiture et plancher.",
  bac: "Calcule un apport par transmission avec U, surface et écart de température.",
  bts: "Établis les hypothèses et sépare les zones et régimes pertinents.",
  ...
  consigne: "Attention, le simulateur de cette escale est celui du calcul sur l’air : il chiffre un débit, pas un mur. Ce qu’il montre vaut pourtant pour les deux. Laisse le premier curseur tranquille et fais varier seulement l’écart de température : passe de 6 à 12 K et regarde la puissance doubler. Reviens à 6 K, puis double cette fois la quantité avec le premier curseur : la puissance double encore. Pour une paroi, ce rôle-là est tenu par la surface.",
  lecture: "Ne reporte pas le nombre affiché dans un bilan de parois : il chiffre un débit d’air. Ce que la manipulation démontre, c’est la loi commune aux deux calculs — la puissance est proportionnelle à l’écart de température, et proportionnelle à la quantité en jeu. Pour une paroi, remplace le débit par le produit du coefficient U et de la surface, et le raisonnement ne change pas. Compare ensuite ton total aux apports solaires et internes : sur un bâtiment récent bien isolé, la transmission n’est plus la part dominante du bilan d’été.",
