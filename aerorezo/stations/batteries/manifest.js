...
(window.AEROREZO_STATIONS = window.AEROREZO_STATIONS || []).push({
  ...
  cap: "Observez l’air se réchauffer ou se refroidir.",
  bac: "Reliez puissance, débit d’air et écart de température.",
  bts: "Analysez batterie froide avec refroidissement sensible et déshumidification éventuelle.",

  /* Découvrir — ce que l'élève observe, pas ce qu'il doit conclure. */
  decouverte: "Le bloc au centre n’est pas un rectangle plein : un serpentin le traverse de part en part, noyé dans un faisceau d’ailettes serrées. L’air passe entre les ailettes, le fluide passe dans les tubes, et les deux ne se touchent jamais. Regardez maintenant ce qui est dessiné juste en dessous — un bac, et un tuyau qui fait une boucle. Personne n’a versé d’eau dans cette centrale. Il va pourtant en sortir, en continu.",
  ...
  consigne: "Réglez le débit sur 2 500 m³/h et l’écart sur 9 °C, et notez la puissance obtenue. Doublez ensuite le débit sans toucher à l’écart : la puissance double aussi. Revenez au débit de départ et doublez l’écart : elle double encore. Cherchez enfin un couple débit-écart qui donne environ 5 kW — vous verrez qu’il en existe plusieurs, et que c’est le projet qui tranche, pas le calcul.",
